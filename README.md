...
> **Note:** Production builds and deployments must use `-tags embed`. The frontend is compiled into the Go binary and must not be deployed or configured as a separate production static directory.
