...
// GMPayWebhook handles GM Pay/Epusdt webhook events.
// POST /api/v1/payment/webhook/gmpay
func (h *PaymentWebhookHandler) GMPayWebhook(c *gin.Context) {
	h.handleNotify(c, payment.TypeGMPay)
}
