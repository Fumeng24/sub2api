...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		AffiliateBindBonusAmount:               settings.AffiliateBindBonusAmount,
...
type UpdateSettingsRequest struct {
	...
	AffiliateBindBonusAmount                  *float64                          `json:"affiliate_bind_bonus_amount"`
...
func (h *SettingHandler) UpdateSettings(c *gin.Context) {
	...
	affiliateBindBonusAmount := previousSettings.AffiliateBindBonusAmount
	if req.AffiliateBindBonusAmount != nil {
		affiliateBindBonusAmount = *req.AffiliateBindBonusAmount
	}
	if affiliateBindBonusAmount < 0 {
		affiliateBindBonusAmount = service.AffiliateBindBonusAmountDefault
	}
	...
	settings := &service.SystemSettings{
		...
		AffiliateBindBonusAmount:               affiliateBindBonusAmount,
	...
	payload := dto.SystemSettings{
		...
		AffiliateBindBonusAmount:               updatedSettings.AffiliateBindBonusAmount,
...
func diffSettings(before *service.SystemSettings, after *service.SystemSettings, beforeAuthSourceDefaults *service.AuthSourceDefaultSettings, afterAuthSourceDefaults *service.AuthSourceDefaultSettings, req UpdateSettingsRequest) []string {
	...
	if before.AffiliateBindBonusAmount != after.AffiliateBindBonusAmount {
		changed = append(changed, "affiliate_bind_bonus_amount")
	}
