...
func (s *SettingService) buildSystemSettingsUpdates(ctx context.Context, settings *SystemSettings) (map[string]string, error) {
	...
	if err := s.prepareSystemSettingsUpdatesCustom(ctx, settings); err != nil {
		return nil, err
	}
	...
	if err := appendSystemSettingsUpdatesCustom(updates, settings); err != nil {
		return nil, err
	}
...
func (s *SettingService) refreshCachedSettings(settings *SystemSettings) {
	...
	s.refreshCachedSettingsCustom(settings)
