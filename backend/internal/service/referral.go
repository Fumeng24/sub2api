...
var (
	ErrReferralCodeNotFound   = infraerrors.BadRequest("REFERRAL_CODE_NOT_FOUND", "referral code not found or invalid")
	ErrReferralCodeInvalid    = infraerrors.BadRequest("REFERRAL_CODE_INVALID", "referral code is invalid")
	ErrSelfReferralNotAllowed = infraerrors.BadRequest("SELF_REFERRAL_NOT_ALLOWED", "cannot use your own referral code")
	ErrAlreadyReferred        = infraerrors.Conflict("ALREADY_REFERRED", "this user has already been referred")
)
