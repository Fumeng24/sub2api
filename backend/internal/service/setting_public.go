...
func defaultLoginAgreementDocuments() []LoginAgreementDocument {
	return withSiteDefaultLoginAgreementDocuments([]LoginAgreementDocument{
		{
			ID:        "terms",
			Title:     "服务条款",
			ContentMD: "",
...
func normalizeLoginAgreementDocuments(docs []LoginAgreementDocument) []LoginAgreementDocument {
	...
	for i, doc := range docs {
		...
		content = withSiteDefaultLoginAgreementDocumentContent(doc.ID, title, content)
		if title == "" && content == "" {
			continue
		}
...
func (s *SettingService) GetPublicSettings(ctx context.Context) (*PublicSettings, error) {
	...
	return withPublicSettingsCustom(&PublicSettings{
