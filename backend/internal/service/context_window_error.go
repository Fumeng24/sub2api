...
const clientFacingContextWindowExceededMessage = "Your input exceeds the model context window. Please reduce the conversation length, start a new chat, or compact the context before retrying."
