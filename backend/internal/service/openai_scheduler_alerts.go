...
func (s *OpenAIGatewayService) emitOpenAISelectionEmptyAlert(ctx context.Context, req OpenAIAccountScheduleRequest, decision OpenAIAccountScheduleDecision, err error) {
	...
	dimensions := map[string]any{
		...
		"image_generation_bridge_supported_count":   diag.ImageGenerationBridgeSupportedCount,
		...
		"status_filtered_count":                     diag.StatusFilteredCount,
		"temp_unschedulable_filtered_count":         diag.TempUnschedulableFilteredCount,
		"overload_filtered_count":                   diag.OverloadFilteredCount,
		"rate_limit_filtered_count":                 diag.RateLimitFilteredCount,
		"model_rate_limit_filtered_count":           diag.ModelRateLimitFilteredCount,
		"image_generation_bridge_unsupported_count": diag.ImageGenerationBridgeUnsupportedCount,
		"channel_pricing_restriction_count":         diag.ChannelRestrictionFilteredCount,
		"group_scope_filtered_count":                diag.GroupScopeFilteredCount,
		"group_binding_account_ids":                 diag.GroupBindingAccountIDs,
		"active_schedulable_account_ids":            diag.ActiveSchedulableAccountIDs,
		...
		"image_generation_bridge_supported_ids":     diag.ImageGenerationBridgeSupportedAccountIDs,
		...
		"ordered_candidate_account_ids":             diag.OrderedCandidateAccountIDs,
		...
		"image_generation_bridge_unsupported_ids":   diag.ImageGenerationBridgeUnsupportedAccountIDs,
		"channel_pricing_restriction_ids":           diag.ChannelRestrictionAccountIDs,
