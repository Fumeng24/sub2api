...
func TestGatewayServiceResolveBillingRateMultiplier_DiscountsGroupIDWithoutHydratedGroup(t *testing.T) {
	groupID := int64(11)
	discount := 0.5
	...
	got := svc.resolveBillingRateMultiplier(context.Background(), &User{ID: 601}, &APIKey{
		ID:      501,
		GroupID: i64p(groupID),
	})
