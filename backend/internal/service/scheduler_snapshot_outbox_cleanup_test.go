...
func (c *outboxCleanupCache) SetBucketMembers(ctx context.Context, bucket SchedulerBucket, accountIDs []int64) error {
	return nil
}

func (c *outboxCleanupCache) RemoveAccountFromBuckets(ctx context.Context, accountID int64) error {
	return nil
}
...
func TestSchedulerSnapshotServiceCleanupSkipsNonPositiveWatermark(t *testing.T) {
	...
	svc := NewSchedulerSnapshotService(&outboxCleanupCache{}, repo, nil, nil, nil, nil)
