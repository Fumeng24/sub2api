...
// Package web serves frontend assets from an external dist directory when the
// binary is built without embedded assets.
package web
...
// FrontendServer serves the external frontend with settings injection.
...
func (s *FrontendServer) fileExists(name string) bool {
