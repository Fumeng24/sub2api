...
func ProvideRouter(
	...
	return SetupRouter(r, handlers, jwtAuth, adminAuth, adminOrSupportAuth, apiKeyAuth, apiKeyService, subscriptionService, opsService, settingService, cfg, redisClient)
}
