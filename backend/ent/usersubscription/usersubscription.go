...
const (
	...
	// FieldAutoResetDaily holds the string denoting the auto_reset_daily field in the database.
	FieldAutoResetDaily = "auto_reset_daily"
...
var (
	...
	// DefaultAutoResetDaily holds the default value on creation for the "auto_reset_daily" field.
	DefaultAutoResetDaily bool
...
// ByAutoResetDaily orders the results by the auto_reset_daily field.
func ByAutoResetDaily(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldAutoResetDaily, opts...).ToFunc()
}
