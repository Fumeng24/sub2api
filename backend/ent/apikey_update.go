...
func (_u *APIKeyUpdate) SetCategory(v string) *APIKeyUpdate {
	_u.mutation.SetCategory(v)
	return _u
}

// SetNillableCategory sets the "category" field if the given value is not nil.
func (_u *APIKeyUpdate) SetNillableCategory(v *string) *APIKeyUpdate {
	if v != nil {
		_u.SetCategory(*v)
	}
	return _u
...
// SetCategory sets the "category" field.
func (_u *APIKeyUpdateOne) SetCategory(v string) *APIKeyUpdateOne {
	_u.mutation.SetCategory(v)
	return _u
}

// SetNillableCategory sets the "category" field if the given value is not nil.
func (_u *APIKeyUpdateOne) SetNillableCategory(v *string) *APIKeyUpdateOne {
	if v != nil {
		_u.SetCategory(*v)
	}
	return _u
