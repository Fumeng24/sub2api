...
const (
	// Label holds the string label denoting the accountmonitorcheck type in the database.
	Label = "account_monitor_check"
	// FieldID holds the string denoting the id field in the database.
	FieldID = "id"
	// FieldAccountMonitorID holds the string denoting the account_monitor_id field in the database.
	FieldAccountMonitorID = "account_monitor_id"
	...
	EdgeMonitor = "monitor"
	// Table holds the table name of the accountmonitorcheck in the database.
	Table = "account_monitor_checks"
	// MonitorTable is the table that holds the monitor relation/edge.
	MonitorTable = "account_monitor_checks"
	// MonitorInverseTable is the table name for the AccountMonitor entity.
	// It exists in this package in order to avoid circular dependency with the "accountmonitor" package.
	MonitorInverseTable = "account_monitors"
	// MonitorColumn is the table column denoting the monitor relation/edge.
	MonitorColumn = "account_monitor_id"
)

// Columns holds all SQL columns for accountmonitorcheck fields.
var Columns = []string{
	FieldID,
	FieldAccountMonitorID,
	FieldModel,
	FieldStatus,
	FieldLatencyMs,
	FieldPingLatencyMs,
...
func StatusValidator(s Status) error {
	...
	case StatusOperational, StatusDegraded, StatusFailed, StatusError:
		return nil
	default:
		return fmt.Errorf("accountmonitorcheck: invalid enum value for status field: %q", s)
	}
}

// OrderOption defines the ordering options for the AccountMonitorCheck queries.
...
// ByAccountMonitorID orders the results by the account_monitor_id field.
func ByAccountMonitorID(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldAccountMonitorID, opts...).ToFunc()
}
