...
import { safeGetStorageItem } from '@/utils/browserStorage'
import { clearAppReloadMarker, recoverFromChunkLoadError } from '@/utils/chunkRecovery'
import './style.css'
...
function initThemeClass() {
  const savedTheme = safeGetStorageItem('localStorage', 'theme')
  const prefersDark =
