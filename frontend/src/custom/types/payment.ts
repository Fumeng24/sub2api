...
export type PaymentType = 'alipay' | 'wxpay' | 'alipay_direct' | 'wxpay_direct' | 'stripe' | 'easypay' | 'airwallex' | 'gmpay' | 'usdt'

export type OrderType = 'balance' | 'subscription'

export type PaymentRecordSource = 'payment_order' | 'redeem_code' | 'admin_balance' | 'affiliate_rebate'

export type PaymentBusinessCategory =
  | ''
  | 'recharge'
  | 'manual_collection'
  | 'manual_refund'
...
export interface PaymentConfig {
  ...
  balance_recharge_unlock_threshold: number
...
export interface CheckoutInfoResponse {
  ...
  balance_disabled: boolean
  balance_recharge_available?: boolean
  balance_recharge_unlock_threshold?: number
  balance_recharge_net_amount?: number
  balance_recharge_multiplier: number
...
export interface PaymentOrder {
  id: number
  source_id?: number
  record_source?: PaymentRecordSource
  record_source_label?: string
  business_category?: PaymentBusinessCategory
  user_id: number
  amount: number
  pay_amount: number
  currency?: string
