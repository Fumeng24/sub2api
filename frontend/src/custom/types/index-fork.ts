...
import type * as Custom from './index'
...
export interface User {
  ...
  role: Custom.UserRole // User role for authorization
...
export interface AdminUser extends User, Custom.AdminUserCustom {
  // 管理员备注（普通用户接口不返回）
  notes: string
...
export interface UserAffiliateDetail extends Custom.UserAffiliateDetailCustom {
  user_id: number
  aff_code: string
...
export interface PublicSettings extends Custom.PublicSettingsCustom {
...
export interface Group extends Custom.GroupCustom<ModelsListConfig> {
  id: number
  name: string
...
export interface AdminGroup extends Group, Custom.AdminGroupCustom {
...
export interface ApiKey extends Custom.ApiKeyCustom {
  id: number
  user_id: number
  key: string
  name: string
...
export interface CreateApiKeyRequest extends Custom.CreateApiKeyRequestCustom {
  name: string
  group_id?: number | null
...
export interface UpdateApiKeyRequest extends Custom.UpdateApiKeyRequestCustom {
  name?: string
  group_id?: number | null
  status?: 'active' | 'inactive'
  ip_whitelist?: string[]
...
export interface CreateGroupRequest extends Custom.GroupMutationCustom {
  name: string
  description?: string | null
  platform?: GroupPlatform
  rate_multiplier?: number
...
export interface UpdateGroupRequest extends Custom.UpdateGroupRequestCustom {
  name?: string
  description?: string | null
  platform?: GroupPlatform
  rate_multiplier?: number
...
export interface Account extends Custom.AccountCustom {
  id: number
  name: string
  notes?: string | null
  platform: AccountPlatform
  ...
  extra?: (CodexUsageSnapshot & OpenAICompactState & Custom.AccountExtraCustom & {
...
export type RedeemCodeType = Custom.RedeemCodeTypeCustom
...
export interface RedeemCode extends Custom.RedeemCodeCustom {
  id: number
  code: string
  type: RedeemCodeType
  value: number
...
export interface BatchUpdateRedeemCodeFields extends Custom.BatchUpdateRedeemCodeFieldsCustom {
...
export interface UpdateUserRequest extends Custom.UpdateUserRequestCustom {
  email?: string
  password?: string
  username?: string
  notes?: string
...
export interface UserSubscription extends Custom.UserSubscriptionCustom {
  id: number
  user_id: number
  group_id: number
...
// Local product contracts remain available through the canonical `@/types` entrypoint.
