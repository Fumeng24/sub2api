          ...
          <div v-if="paidOrder" class="w-full rounded-lg border border-[color:var(--apple-border-soft)] bg-[var(--apple-surface-elevated)] p-4">
            <div class="space-y-2 text-sm">
              ...
              <div class="flex justify-between">
                ...
                <span class="font-medium text-[var(--apple-text)]">{{ paidOrder.order_type === 'balance' ? formatBalanceCreditAmount(paidOrder.amount, localeCode) : formatGatewayAmount(paidOrder.amount) }}</span>
              </div>
              <div class="flex justify-between">
...
import { getPaymentPopupFeatures, isBuiltInAlipayMethod, isBuiltInWxpayMethod } from '@/custom/payment/providerConfig'
import { formatPaymentAmount, normalizePaymentCurrency } from '@/components/payment/currency'
import { formatBalanceCreditAmount } from '@/custom/payment/orderAmounts'
