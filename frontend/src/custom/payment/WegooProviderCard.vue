...
import type { TypeOption } from '@/custom/payment/providerConfig'
import { PAYMENT_MODE_QRCODE, PAYMENT_MODE_POPUP, PAYMENT_MODE_REDIRECT } from '@/custom/payment/providerConfig'
...
const PROVIDER_KEY_LABELS: Record<string, string> = {
  ...
  gmpay: 'admin.settings.payment.providerGmpay',
}
