...
import PaymentStatusPanel from '../WegooPaymentStatusPanel.vue'
...
describe('PaymentStatusPanel', () => {
  ...
  it('keeps RECHARGING non-terminal until fulfillment completes', async () => {
  ...
  it('actively verifies a stuck Alipay order and settles it when upstream confirms payment', async () => {
