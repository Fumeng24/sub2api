...
export const CARD_CODE_PURCHASE_URL = 'https://catfk.com/shop/wegoo'
...
export const WEBHOOK_PATHS: Record<string, string> = {
  ...
  gmpay: '/api/v1/payment/webhook/gmpay',
}
...
export const PROVIDER_CALLBACK_PATHS: Record<string, CallbackPaths> = {
  ...
  gmpay: { notifyUrl: WEBHOOK_PATHS.gmpay, returnUrl: RETURN_PATH },
...
export const PROVIDER_CONFIG_FIELDS: Record<string, ConfigFieldDef[]> = {
  ...
  gmpay: [
    { key: 'apiBase', label: '', sensitive: false, hintKey: 'admin.settings.payment.field_gmpayApiBaseHint' },
    { key: 'pid', label: 'PID', sensitive: false },
    { key: 'secretKey', label: '', sensitive: true },
    { key: 'currency', label: '', sensitive: false, defaultValue: 'CNY', hintKey: 'admin.settings.payment.field_gmpayCurrencyHint', options: PAYMENT_CURRENCY_OPTIONS },
    { key: 'token', label: '', sensitive: false, defaultValue: 'USDT' },
    { key: 'network', label: '', sensitive: false, defaultValue: 'tron', hintKey: 'admin.settings.payment.field_gmpayNetworkHint' },
  ],
}
