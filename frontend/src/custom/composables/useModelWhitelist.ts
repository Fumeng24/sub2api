...
const openaiPresetMappings = [
  ...
  { label: 'GPT-5.4 Mini', from: 'gpt-5.4-mini', to: 'gpt-5.4-mini', color: 'bg-sky-100 text-sky-700 hover:bg-sky-200 dark:bg-sky-900/30 dark:text-sky-400' },
  { label: 'Haiku→5.4 Mini', from: 'claude-haiku-4-5-20251001', to: 'gpt-5.4-mini', color: 'bg-emerald-100 text-emerald-700 hover:bg-emerald-200 dark:bg-emerald-900/30 dark:text-emerald-400' },
...
import { getAntigravityDefaultModelMapping } from '@/custom/api/admin/accounts'
