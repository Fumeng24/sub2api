...
import type { OpsRequestDetailsPreset } from '@/custom/admin/ops/WegooOpsRequestDetailsModal.vue'
...
<template>
  <div :class="['admin-ops-panel flex flex-col gap-4', props.fullscreen ? 'p-8' : 'p-6']">
    <!-- Top Toolbar -->
    ...
    <div v-if="overview" class="grid grid-cols-1 gap-6 lg:grid-cols-12">
      ...
      <div :class="['admin-ops-surface lg:col-span-5', props.fullscreen ? 'p-6' : 'p-4']">
        <div class="grid h-full grid-cols-1 gap-6 md:grid-cols-[200px_1fr] md:items-center">
          <!-- 1) Health Score -->
          <div
            class="group relative flex cursor-pointer flex-col items-center justify-center rounded-lg py-2 transition-all hover:bg-white/60 dark:hover:bg-dark-800/60 md:border-r md:border-gray-200 md:pr-6 dark:md:border-dark-700"
          >
            ...
            >
              <div class="admin-ops-popover p-4">
      ...
      <div class="grid h-full grid-cols-1 content-center gap-4 sm:grid-cols-2 lg:col-span-7 lg:grid-cols-3">
        <!-- Card 1: Requests -->
        <div class="admin-ops-metric" style="order: 1;">
        ...
        <!-- Card 2: SLA -->
        <div class="admin-ops-metric" style="order: 2;">
          <div class="flex items-center justify-between">
            <div class="flex items-center gap-2">
        ...
        <div class="admin-ops-metric" style="order: 4;">
          <div class="flex items-center justify-between">
            <div class="flex items-center gap-1">
        ...
        <!-- Card 5: TTFT -->
        <div class="admin-ops-metric" style="order: 5;">
          <div class="flex items-center justify-between">
            <div class="flex items-center gap-1">
        ...
        <div class="admin-ops-metric" style="order: 3;">
          <div class="flex items-center justify-between">
            <div class="flex items-center gap-1">
        ...
        <div class="admin-ops-metric" style="order: 6;">
          <div class="flex items-center justify-between">
            <div class="flex items-center gap-1">
    ...
    <BaseDialog :show="showJobsDetails" :title="t('admin.ops.jobs')" width="wide" @close="showJobsDetails = false">
      ...
      <div v-else class="space-y-3">
        <div
          ...
          :key="hb.job_name"
          class="rounded-lg border border-gray-100 bg-white p-4 dark:border-dark-700 dark:bg-dark-900"
        >
