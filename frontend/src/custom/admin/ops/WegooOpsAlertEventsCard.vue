...
import type { AlertEvent } from '@/views/admin/ops/types'
import { formatDateTime } from '@/views/admin/ops/utils/opsFormatters'
...
<template>
  <div class="admin-ops-panel p-6">
    ...
    <div v-else-if="empty" class="rounded-lg border border-dashed border-gray-200 p-8 text-center text-sm text-gray-500 dark:border-dark-700 dark:text-gray-400">
