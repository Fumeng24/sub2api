  ...
  <BaseDialog :show="show" :title="title" width="full" :close-on-click-outside="true" @close="close">
    ...
    <div v-else class="space-y-6 p-6">
      ...
      <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div v-if="detail.attempted_key_prefix" class="rounded-lg bg-gray-50 p-4 dark:bg-dark-900">
        ...
        <div v-if="detail.deleted_key_owner_email" class="rounded-lg bg-gray-50 p-4 dark:bg-dark-900">
      ...
      <div class="rounded-lg bg-gray-50 p-6 dark:bg-dark-900">
        ...
        <pre class="mt-4 max-h-[520px] overflow-auto rounded-lg border border-gray-200 bg-white p-4 text-xs text-gray-800 dark:border-dark-700 dark:bg-dark-800 dark:text-gray-100"><code>{{ prettyJSON(primaryResponseBody || '') }}</code></pre>
      </div>
...
import { opsAPI, type OpsErrorDetail as UpstreamOpsErrorDetail } from '@/api/admin/ops'
import { formatDateTime } from '@/utils/format'
import { resolvePrimaryResponseBody, resolveUpstreamPayload } from '@/views/admin/ops/utils/errorDetailResponse'

type OpsErrorDetail = UpstreamOpsErrorDetail & {
