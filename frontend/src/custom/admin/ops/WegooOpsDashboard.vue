<template>
  <component :is="isFullscreen ? 'div' : AppLayout" :class="isFullscreen ? 'flex min-h-screen flex-col justify-center bg-gray-50 dark:bg-dark-950' : ''">
    <div :class="[isFullscreen ? 'p-4 md:p-6' : '', 'admin-apple-page admin-ops-page space-y-6 pb-12']">
      <div
        v-if="errorMessage"
        class="rounded-lg border border-red-200 bg-red-50 p-3 text-sm text-red-600 dark:border-red-900/40 dark:bg-red-900/20 dark:text-red-400"
      >
        {{ errorMessage }}
      </div>
...
import OpsDashboardHeader from '@/custom/admin/ops/WegooOpsDashboardHeader.vue'
import OpsDashboardSkeleton from '@/custom/admin/ops/WegooOpsDashboardSkeleton.vue'
import OpsConcurrencyCard from '@/custom/admin/ops/WegooOpsConcurrencyCard.vue'
...
import OpsAlertEventsCard from '@/custom/admin/ops/WegooOpsAlertEventsCard.vue'
import OpsOpenAITokenStatsCard from '@/views/admin/ops/components/OpsOpenAITokenStatsCard.vue'
import OpsSystemLogTable from '@/views/admin/ops/components/OpsSystemLogTable.vue'
import OpsRequestDetailsModal, { type OpsRequestDetailsPreset } from '@/custom/admin/ops/WegooOpsRequestDetailsModal.vue'
import OpsSettingsDialog from '@/custom/admin/ops/WegooOpsSettingsDialog.vue'
import OpsAlertRulesCard from '@/custom/admin/ops/WegooOpsAlertRulesCard.vue'
