...
import OpsErrorDistributionChart from '../WegooOpsErrorDistributionChart.vue'
import OpsErrorTrendChart from '../WegooOpsErrorTrendChart.vue'
...
describe('Ops SLA-scoped error charts', () => {
  it('错误分布图按 SLA 错误数统计，不把业务限制错误算进请求错误分布', () => {
    ...
    expect(wrapper.classes()).toContain('admin-ops-panel')
