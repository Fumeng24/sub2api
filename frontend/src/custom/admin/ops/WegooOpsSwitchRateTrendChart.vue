...
import type { ChartState } from '@/views/admin/ops/types'
import { formatHistoryLabel, sumNumbers } from '@/views/admin/ops/utils/opsFormatters'
import HelpTooltip from '@/custom/common/WegooHelpTooltip.vue'
import EmptyState from '@/custom/common/WegooEmptyState.vue'

defineOptions({ name: 'OpsSwitchRateTrendChart' })
...
<template>
  <div data-testid="ops-switch-rate-chart" class="admin-ops-panel flex h-full flex-col p-6">
