<template>
  <div data-test="account-bulk-actions" class="mb-4 flex flex-col gap-3 rounded-lg border border-primary-100 bg-primary-50 p-3 dark:border-primary-900/40 dark:bg-primary-900/20 lg:flex-row lg:items-center lg:justify-between">
    ...
    <div class="flex w-full min-w-0 flex-wrap items-center justify-end gap-2 lg:w-auto">
      ...
      <button data-test="account-bulk-edit-filtered" @click="$emit('edit-filtered')" class="btn btn-primary btn-sm">
