      ...
      <template #filters>
        ...
        <div class="admin-toolbar">
          ...
          <div class="admin-toolbar-filters">
            <!-- User Search -->
            <div
              class="admin-toolbar-search relative"
            ...
            <div class="admin-toolbar-filter-wide">
              <Select
          ...
          <div class="admin-toolbar-actions">
            ...
            <button @click="showAssignModal = true" class="btn btn-primary admin-toolbar-primary">
          ...
          <template #cell-usage="{ row }">
            <div class="min-w-[280px] space-y-2">
              ...
              <div
                ...
                "
                class="flex items-center gap-2 rounded-lg border border-emerald-200 bg-white px-3 py-2 dark:border-emerald-900/40 dark:bg-dark-800/70"
              >
    ...
    <teleport to="body">
      <transition name="modal">
        <div v-if="showGuideModal" class="fixed inset-0 z-50 flex items-center justify-center p-4" @mousedown.self="showGuideModal = false">
          ...
          <div class="admin-apple-modal-panel relative max-h-[85vh] w-full max-w-2xl overflow-y-auto p-6">
...
async function confirmResetWithCost() {
  ...
  try {
    const updated = await resetSubscriptionWithCost(resetWithCostSubscription.value.id)
