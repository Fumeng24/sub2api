      ...
      <template #filters>
        <div class="admin-toolbar">
          ...
          <div class="admin-toolbar-filters">
            ...
            <div v-if="visibleFilters.has('role')" class="admin-toolbar-filter">
              <Select
            ...
            <div v-if="visibleFilters.has('status')" class="admin-toolbar-filter">
              <Select
            ...
            <div v-if="visibleFilters.has('group')" class="admin-toolbar-filter-wide">
              <Select
            ...
            <div v-if="visibleFilters.has('apiKeyGroup')" class="admin-toolbar-filter-wide">
              <Select
            ...
            <template v-for="(value, attrId) in activeAttributeFilters" :key="attrId">
              <div
                ...
                class="admin-toolbar-filter relative"
              >
          ...
          <div class="admin-toolbar-actions">
            ...
            <button @click="showCreateModal = true" class="btn btn-primary admin-toolbar-primary">
...
import type { PlatformQuotaItem } from '@/custom/api/admin/users'
...
import { buildApiKeyGroupFilterOptions } from '@/views/admin/apiKeyGroupFilterOptions'
...
import UserCreateModal from '@/custom/admin/user/WegooUserCreateModal.vue'
import UserEditModal from '@/custom/admin/user/WegooUserEditModal.vue'
import UserPlatformQuotaModal from '@/components/admin/user/UserPlatformQuotaModal.vue'
import UserApiKeysModal from '@/custom/admin/user/WegooUserApiKeysModal.vue'
import UserAllowedGroupsModal from '@/custom/admin/user/WegooUserAllowedGroupsModal.vue'
import UserBalanceModal from '@/custom/admin/user/WegooUserBalanceModal.vue'
