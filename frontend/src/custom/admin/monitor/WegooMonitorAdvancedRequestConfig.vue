...
import type { APIMode, BodyOverrideMode, Provider } from '@/custom/api/admin/channelMonitor'
import {
  API_MODE_RESPONSES,
  DEFAULT_GROK_MODEL,
  PROVIDER_GROK,
...
const bodyPlaceholder = computed(() => {
  ...
  if (props.provider === PROVIDER_OPENAI || props.provider === PROVIDER_GROK) {
    ...
    const model = props.provider === PROVIDER_GROK ? DEFAULT_GROK_MODEL : 'gpt-5.4-mini'
