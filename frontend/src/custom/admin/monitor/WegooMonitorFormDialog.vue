...
import MonitorKeyPickerDialog from '@/custom/admin/monitor/WegooMonitorKeyPickerDialog.vue'
import MonitorAdvancedRequestConfig from '@/custom/admin/monitor/WegooMonitorAdvancedRequestConfig.vue'
...
async function handleSubmit() {
  ...
  try {
    ...
    if (target) {
      ...
      await channelMonitorAPI.update(target.id, req)
      appStore.showSuccess(t('admin.channelMonitor.updateSuccess'))
    } else {
      await channelMonitorAPI.create(buildPayload())
