<template>
  <div data-test="channel-monitor-filters" class="admin-toolbar">
    <!-- Left: Search + Filters -->
    ...
    <div class="admin-toolbar-actions">
      ...
      <button data-test="channel-monitor-create" @click="$emit('create')" class="btn btn-primary admin-toolbar-primary">
...
import type { Provider } from '@/custom/api/admin/channelMonitor'
