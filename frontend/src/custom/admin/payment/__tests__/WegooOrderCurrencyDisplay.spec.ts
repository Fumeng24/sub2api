...
import AdminRefundDialog from '../WegooAdminRefundDialog.vue'
...
describe('active order currency display', () => {
  it('uses order currency for pay_amount and settlement currency for user balance', () => {
