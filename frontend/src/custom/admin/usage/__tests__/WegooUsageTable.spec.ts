...
import UsageTable from '../WegooUsageTable.vue'
...
describe('admin UsageTable tooltip', () => {
  ...
  it('shows mapped models for regular user-shaped rows', () => {
    const row = {
      request_id: 'req-user-model-map',
      model: 'gpt-5.6-sol',
      upstream_model: 'gpt-5.6-luna',
      model_mapping_chain: 'gpt-5.6-sol→gpt-5.6-luna',
      actual_cost: 0,
      total_cost: 0,
      rate_multiplier: 1,
      input_cost: 0,
