...
import type { AdminUser, UpdateUserRequest, PaginatedResponse, ApiKey, BalanceBusinessCategory } from '@/types'
...
export async function list(
  ...
  filters?: {
    ...
    has_group_rate_config?: boolean // only users whose effective group pricing differs from default
  ...
  const params: Record<string, any> = {
    ...
    has_group_rate_config: filters?.has_group_rate_config,
...
export async function updateBalance(
  ...
  notes?: string,
  businessCategory?: BalanceBusinessCategory
): Promise<AdminUser> {
