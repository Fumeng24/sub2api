...
import ProfileView from '@/custom/user/WegooProfileView.vue'
...
describe('ProfileView', () => {
  ...
  it('renders the simplified single-column profile shell without separate stat cards', async () => {
    const wrapper = mount(ProfileView, {
      global: {
        stubs: {
          ...
          WegooProfileHero: { template: '<div data-testid="profile-hero" />' },
    ...
    expect(wrapper.get('[data-testid="profile-hero"]').exists()).toBe(true)
