...
import MonitorDetailDialog from '@/custom/user/monitor/WegooMonitorDetailDialog.vue'
...
// ── Computed ──
const overallStatus = computed<OverallStatus>(() => resolveOverallMonitorStatus(items.value))
