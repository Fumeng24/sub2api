...
const headerSource = readFileSync(resolve(dir, '../../../custom/layout/WegooAppHeader.vue'), 'utf8')
const sidebarSource = readFileSync(resolve(dir, '../../../custom/layout/WegooAppSidebar.vue'), 'utf8')
const homeViewSource = readFileSync(
  resolve(dir, '../../../custom/home/WegooHomeView.vue'),
  'utf8',
)
const keyUsageViewSource = readFileSync(
  resolve(dir, '../../../custom/public/WegooKeyUsageView.vue'),
  'utf8',
)
