<template>
  <div class="fixed inset-0 z-50 overflow-y-auto">
    <div class="flex min-h-full items-center justify-center p-4">
      ...
      <div class="relative w-full max-w-md transform rounded-lg border border-gray-200 bg-white p-6 shadow-sm transition-all dark:border-dark-700 dark:bg-dark-900">
        <!-- Header -->
        <div class="mb-6 text-center">
          <div class="mx-auto flex h-12 w-12 items-center justify-center rounded-lg border border-primary-100 bg-primary-50 dark:border-primary-500/30 dark:bg-primary-500/10">
        ...
        <div class="mb-6">
          ...
          <div class="flex justify-center gap-2">
            <input
              ...
              pattern="[0-9]"
              autocomplete="off"
              class="h-12 w-10 rounded-lg border border-gray-300 bg-white text-center text-lg font-semibold text-gray-950 focus:border-primary-500 focus:ring-primary-500 dark:border-dark-700 dark:bg-dark-900 dark:text-white"
              :disabled="verifying"
