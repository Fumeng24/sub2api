...
const AccountBulkModelTestModal = defineAsyncComponent(() => import('@/components/admin/account/AccountBulkModelTestModal.vue'))
...
const AccountBulkVerifyModal = defineAsyncComponent(() => import('@/components/admin/AccountBulkVerifyModal.vue'))
