<template>
  <AppLayout>
    ...
    <AccountBulkModelTestModal :show="showBulkModelTest" :accounts="bulkModelTestAccounts" @close="closeBulkModelTest" />
...
import AccountBulkModelTestModal from '@/components/admin/account/AccountBulkModelTestModal.vue'
