<template>
  <AppLayout>
    <div class="admin-apple-page admin-settings-page mx-auto max-w-6xl space-y-6">
      <!-- Loading State -->
                ...
                <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                  <div>
                    ...
                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                      {{
                        localText(
                          "文档名称可自定义，内容按 Markdown 保存。可参考：服务条款、使用政策、支持的国家与地区、服务特定条款。",
        ...
        <div class="card">
          ...
          <div class="space-y-5 p-6">
            ...
            <div v-if="form.affiliate_enabled" class="space-y-6">
              ...
              <div>
                <label class="input-label">
                  {{ t('admin.settings.features.affiliate.bindBonusAmount') }}
                </label>
                <input
                  v-model.number="form.affiliate_bind_bonus_amount"
                  type="number"
                  step="0.01"
                  min="0"
                  class="input"
                />
                <p class="mt-1 text-xs text-gray-400">
                  {{ t('admin.settings.features.affiliate.bindBonusAmountDesc') }}
                </p>
              </div>
...
const defaultLoginAgreementUpdatedAt = "2026-06-23";
const defaultTermsContentMd = `# 服务条款
...
const defaultUsagePolicyContentMd = `# 使用政策
...
const defaultSupportedRegionsContentMd = `# 支持的国家与地区
...
支持地区和当前可用能力会在页面展示。未列入支持列表的地区不在当前服务范围内；已开放地区的模型、支付方式和功能状态以页面展示为准，官方满血和永远不掺水承诺保持不变。
...
const defaultServiceSpecificTermsContentMd = `# 服务特定条款
  ...
  return [
    {
      id: "terms",
      title: "服务条款",
      content_md: defaultTermsContentMd,
    },
    {
      id: "usage-policy",
      title: "使用政策",
      content_md: defaultUsagePolicyContentMd,
    },
    {
      id: "supported-regions",
      title: "支持的国家与地区",
      content_md: defaultSupportedRegionsContentMd,
    },
    {
      id: "service-specific-terms",
      title: "服务特定条款",
      content_md: defaultServiceSpecificTermsContentMd,
    },
  ];
}
...
const form = reactive<SettingsForm>({
  ...
  login_agreement_updated_at: defaultLoginAgreementUpdatedAt,
...
async function loadSettings() {
  ...
  try {
    ...
    form.login_agreement_updated_at =
      settings.login_agreement_updated_at || defaultLoginAgreementUpdatedAt;
...
async function saveSettings() {
  ...
  try {
    ...
    const payload: UpdateSettingsRequest = {
      ...
      affiliate_bind_bonus_amount: Math.max(0, Number(form.affiliate_bind_bonus_amount) || 0),
...
/* ============ 系统设置 Tab 导航 ============ */
.settings-tabs-shell {
  @apply sticky z-20 -mx-1 rounded-lg border p-1.5 backdrop-blur-xl;
  top: 4.75rem;
  border-color: var(--apple-border);
  background: color-mix(in srgb, var(--apple-surface) 94%, transparent);
...
.dark .settings-tabs-shell {
  border-color: var(--apple-border);
  background: color-mix(in srgb, var(--apple-surface) 90%, transparent);
  box-shadow: var(--apple-shadow-sm);
}
