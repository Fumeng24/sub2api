        ...
        <div class="card p-6">
          ...
          <div class="mt-5 grid gap-4 md:grid-cols-2">
            <div class="min-w-0 space-y-2">
              ...
              <div class="flex min-w-0 flex-col gap-2 rounded-xl border border-gray-200 bg-gray-50 px-3 py-2 dark:border-dark-700 dark:bg-dark-900 sm:flex-row sm:items-center">
                <code class="block min-w-0 flex-1 break-all text-sm font-semibold text-gray-900 dark:text-white sm:truncate sm:break-normal" v-text="detail.aff_code"></code>
