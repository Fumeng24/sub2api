export default {
  ...
  admin: {
    ...
    settings: {
      ...
      payment: {
        ...
        balanceRechargeMultiplier: 'CNY per 1 Balance Credit',
        balanceRechargeMultiplierHint: 'How much CNY each 1 balance credit costs; credited balance for CNY payments = paid amount / this value',
        balanceRechargePreview: 'Preview: 1 balance credit = ¥{cny}',
        balanceRechargeChangeHint: 'Changes only affect newly created recharge orders and will not rewrite historical orders.',
  ...
  payment: {
    ...
    rechargeRatePreview: 'Current settlement price: 1 balance credit = ¥{cny}',
