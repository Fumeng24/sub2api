<template>
  ...
  <Teleport to="body">
    <Transition name="agreement-fade">
      <div
        v-if="dialogVisible"
        class="login-agreement-shell fixed inset-0 z-[140] bg-gray-950/55 backdrop-blur-sm dark:bg-black/[0.72]"
        role="dialog"
        aria-modal="true"
      >
        <div class="login-agreement-card flex w-full max-w-[600px] flex-col overflow-hidden rounded-lg border border-gray-200 bg-white shadow-[0_24px_80px_rgb(0_0_0_/_18%)] dark:border-white/10 dark:bg-[#161617] dark:shadow-[0_24px_80px_rgb(0_0_0_/_55%)]">
