<template>
  ...
  >
    <div class="space-y-4">
      ...
      <template v-else>
        <section class="rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-dark-700 dark:bg-dark-800/50">
          ...
          <div class="mt-3 grid gap-3 sm:grid-cols-2">
            <div
              ...
              class="min-w-0 rounded-md border border-gray-200 bg-white px-3 py-2 dark:border-dark-700 dark:bg-dark-800"
            >
          ...
          <div
            ...
            class="mt-3 rounded-md border border-gray-200 bg-white px-3 py-2 dark:border-dark-700 dark:bg-dark-800"
          >
            ...
            <div class="mt-2 space-y-2">
              <div v-for="endpoint in endpointOptions" :key="endpoint.endpoint" class="min-w-0">
                <div class="flex flex-wrap items-center gap-2">
                  <span class="text-xs font-medium text-gray-700 dark:text-gray-300">{{ endpoint.name }}</span>
                  <span v-if="endpoint.isDefault" class="badge badge-gray text-[10px]">
