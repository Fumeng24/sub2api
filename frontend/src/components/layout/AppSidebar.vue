...
// V2 is an administrator-only passive observer; its visibility must not depend
// on the public V1/V2 execution mode.
const flagChannelMonitorV2 = flagChannelMonitor
